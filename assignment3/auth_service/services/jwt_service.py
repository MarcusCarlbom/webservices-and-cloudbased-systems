...
# Read the secret from the environment so it can be rotated without rebuilding
# the image. The fallback value matches the original assignment 2 default.
SECRET_KEY = os.environ.get("JWT_SECRET", "super_safe_no_leakage_key_67")
